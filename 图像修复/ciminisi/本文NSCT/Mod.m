...
for i=1:Len(1)-1
    for j=1:Len(2)-1
        if( fillRegion(i,j)==0 &  fillRegion(i,j+1)==255 )
           fillRegion(i,j-2)=100;fillRegion(i,j-1)=100; fillRegion(i,j)=100;fillRegion(i,j+1)=100;fillRegion(i,j+2)=100;
%             fillRegion(i,j)=100;fillRegion(i,j-1)=100;fillRegion(i,j-2)=100;fillRegion(i,j-3)=100;
        ...
        if(  fillRegion(i,j)==255 &  fillRegion(i,j+1)==0 )
          fillRegion(i,j+1)=100;fillRegion(i,j+2)=100; fillRegion(i,j)=100;fillRegion(i,j-1)=100;fillRegion(i,j-2)=100;
