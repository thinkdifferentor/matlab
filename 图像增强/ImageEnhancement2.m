...
%     end
% end
% figure('name','自编模版--均值滤波'),imshow(Iavg);
% %%自编模版--中值滤波
% n=3;%行数为3
% Imid=I3;%设置传入的图片
% for i=2:length(I1)-1
...
%     end
% end
% figure('name','自编模版--中值滤波'),imshow(Imid);